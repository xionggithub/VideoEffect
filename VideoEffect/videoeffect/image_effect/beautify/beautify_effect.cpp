...
void ImageBeautifyEffect::renderEffect(OpenglVideoFrame * inputFrame, OpenglVideoFrame * outputFrame, EffectCallback * filterCallback, GLfloat* vertexCoords, GLfloat* textureCoords) {
    ...
    GL_CHECK_ERROR("AFter switchFBOAttachmentTexture ");
    ...
    GL_CHECK_ERROR("AFter glEnableVertexAttribArray ");
    ...
    GL_CHECK_ERROR("AFter glUniform1f Width && Height ");
    ParamVal val;
    ...
    this->draw();
    GL_CHECK_ERROR("AFter Beauty Filter Draw ");
    ...
    GL_CHECK_ERROR("AFter glBindFramebuffer 0 ");
}
