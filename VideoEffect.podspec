...
Pod::Spec.new do |s|
  ...
  s.subspec 'editmodel' do |editmodel|
      ...
      editmodel.subspec 'blur_scene' do |blur_scene|
        ...
        blur_scene.private_header_files = 'VideoEffect/editmodel/blur_scene/*.h'
      end
      ...
      editmodel.subspec 'selective_blur_scene' do |selective_blur_scene|
        ...
        selective_blur_scene.private_header_files = 'VideoEffect/editmodel/selective_blur_scene/*.h'
      end
     ...
     editmodel.subspec 'text_scene' do |text_scene|
        ...
        text_scene.private_header_files = 'VideoEffect/editmodel/text_scene/*.h'
      end
  end
  s.subspec 'platform_dependent' do |platform_dependent|
      ...
      platform_dependent.private_header_files = 'VideoEffect/platform_dependent/*.h'
  end
  
  s.subspec 'videoeffect' do |videoeffect|
      videoeffect.source_files  = 'VideoEffect/videoeffect/*.{h,m,c,cpp,hpp,frag,vert,glsl}'
      videoeffect.private_header_files = 'VideoEffect/videoeffect/*.h'
      videoeffect.subspec 'blur_scene' do |blur_scene|
        ...
        blur_scene.private_header_files = 'VideoEffect/videoeffect/blur_scene/*.h'
        blur_scene.subspec 'shader' do |shader|
          ...
          shader.private_header_files = 'VideoEffect/videoeffect/blur_scene/shader/*.h'
        end
      end
      ...
      videoeffect.subspec 'image_effect' do |image_effect|
         ...
         image_effect.public_header_files = ''
         image_effect.subspec 'beautify' do |beautify|
           ...
           beautify.private_header_files = 'VideoEffect/videoeffect/image_effect/beautify/*.h'
         end
         ...
         image_effect.subspec 'beautify_face' do |beautify_face|
           ...
           beautify_face.private_header_files = 'VideoEffect/videoeffect/image_effect/beautify_face/*.h'
         end
         ...
         image_effect.subspec 'highpass' do |highpass|
           ...
           highpass.private_header_files = 'VideoEffect/videoeffect/image_effect/highpass/*.h'
         end
         ...
         image_effect.subspec 'thin' do |thin|
           ...
           thin.private_header_files = 'VideoEffect/videoeffect/image_effect/thin/*.h'
         end
         ...
         image_effect.subspec 'water_mask' do |water_mask|
           ...
           water_mask.private_header_files = 'VideoEffect/videoeffect/image_effect/water_mask/*.h'
         end
         ...
         image_effect.subspec 'whitening' do |whitening|
           ...
           whitening.private_header_files = 'VideoEffect/videoeffect/image_effect/whitening/*.h'
           whitening.subspec 'shader' do |shader|
            ...
            shader.private_header_files = 'VideoEffect/videoeffect/image_effect/whitening/shader/*.h'
           end
         end
       end
       videoeffect.subspec 'png_sequence' do |png_sequence|
          ...
          png_sequence.private_header_files = 'VideoEffect/videoeffect/png_sequence/*.h'
       end
       ...
       videoeffect.subspec 'saturation_scene' do |saturation_scene|
        ...
        saturation_scene.private_header_files = 'VideoEffect/videoeffect/saturation_scene/*.h'
       end
    end
