...
#         blur_scene.public_header_files = ''
#       end
...
#         selective_blur_scene.public_header_files = ''
#       end
...
#         text_scene.public_header_files = ''
#       end
#   end
...
#            beautify_face.public_header_files = ''
#          end
...
#            water_mask.public_header_files = ''
#          end
...
#           png_sequence.public_header_files = ''
#        end
...
Pod::Spec.new do |s|
  ...
  s.subspec 'videoeffect' do |videoeffect|
    ...
    s.subspec 'videoeffect_avc' do |videoeffect_avc|
      videoeffect_avc.source_files  = 'VideoEffect/videoeffect_avc/*.{acv}'
    end
end
